...
public class appIconParser
{
    ...
    public appIconParser(String input , String destination){
        ...
        try{
            ...
            BufferedImage resizeImageJpg13 = resizeImage(114,114,originalImage, type);
            ...
            BufferedImage resizeImageJpg16 = resizeImage(83,83,originalImage, type);
            ImageIO.write(resizeImageJpg16, "png", new File(""+destination+"/icon83@1x.png"));
