...
public class AppIconMaker
{
    ...
    JRadioButton radPeer = new JRadioButton("About");
	JFileChooser  fileDialog = new JFileChooser();
	
	public AppIconMaker()
	{
		final comframe frame=new comframe("App Icons","images/icon.png",600,400,true,true,true,true);
		...
		choose1.setBackground(Color.GRAY);
		...
		choose2.setBackground(Color.GRAY);
		...
		choose3.setBackground(Color.GRAY);
		...
		choose4.setBackground(Color.GRAY);
		...
		statusLabel = new JLabel("Recomended 1536x1536 Pixel Image");
    ...
    //  headerLabel.setText("Control in action: RadioButton"); 
		radApple.setBounds(150,250,100,30);
		radApple.setBackground(Color.WHITE);
		radMango.setBounds(270,250,200,30);
		radMango.setBackground(Color.WHITE);
		radPeer.setBounds(470,250,100,30);
      ...
      radApple.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {         
           statusLabel.setText("Recomended 1536x1536 pixel" 
           + (e.getStateChange()==1?" Image":"unchecked"));
      ...
      radMango.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {             
           statusLabel.setText("Recomended 2048x2732 pixel" 
           + (e.getStateChange()==1?" Image.":"unchecked")); 
		   		   start2.setEnabled(true);
		   start.setEnabled(true);
      ...
      radPeer.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {             
           statusLabel.setText("Email : rajamohanssingh" 
